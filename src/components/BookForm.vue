<template>
  <form v-on:submit.prevent="bookSubmit(bookData)" class="" action="#" method="post">
    ...
    <div>
      <label for="borrowed"><input v-model="bookData.ownership" type="radio" value="borrowed">borrowed</label>
      <label for="bought"><input v-model="bookData.ownership" type="radio" value="bought">bought</label>
    </div>
